...
exports.initGame = function(sio, socket){
	io = sio; // iniba pangalan for naming convention
	gameSocket = socket;
	...
	gameSocket.on('update', function (pacman, enemies)
	{
		io.emit('render', pacman, enemies);
	});
}
...
function ghostJoinedGame(data){ // 142 at app.js
	...
	if(room != undefined){
		...
		if(noUsers == 2){
			...
			//this.emit('initGhostScreen', data)// 144 app.js
			io.emit('initGhostScreen', data);
		}
	}
}
